    ...
    <b-container class="" >
      <div v-if="this.Answered.length > 0  ">
        ...
        <div class="mt-5 d-flex justify-content-center">
          <b-button v-on:click="CheckRevsionQuiz" size="sm" class="btn btn_light my-2 py-3 px-5 rounded_0 ml-5" type="button"> مراجعة الكل</b-button>
          <b-button v-on:click="SendData" size="sm" class="btn btn_gradient my-2 py-3 px-5 rounded_0" type="button"> تسليم الامتحان</b-button>
